...
double paymentPrice=0;
  ...
  title: Text('Item ${index + 1}: ${widget.cartData[index]['name']}:'),
   subtitle: Text('Price: \NRs:${widget.cartData[index]['price']}'),
    ...
    print("inside order now");
       print(data);
    var bodyy = json.encode(data);
    var urlParse = Uri.parse(url);
    var bearerToken =token1;
    // var bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjIsImlhdCI6MTcxNDE1MDUwNywiZXhwIjoxNzE0NTgyNTA3fQ.V4eIJPsrse1gtXG725bt_4c8ApFnsnh17ESHMh3xhb8";
...
print("where to gh");
 ...
 print(setOtp);
  ...
  context,
  MaterialPageRoute(
    builder: (context) => PaymentPage(paymentPrice: calculateTotalPrice(),orderIds:ordersender,Otp:setOtp),
  ),
);
    },
